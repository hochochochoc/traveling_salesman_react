            ...
            <div>
              ...
              <div className="relative z-10 rounded-lg p-4 text-white">
                ...
                <p className="h-[26rem] text-lg font-semibold">
                  The Traveling Salesman Problem is an issue in computer
                  science, the goal of which is to find the shortest circular
                  route through a set of points.
                </p>
          ...
          {step === 1 && (
            <div>
              ...
              <div className="relative z-10 p-4 text-white">
                ...
                <p className="h-[26rem] text-lg font-semibold">
                  The TSP is used in many contexts where an optimal circular
                  route has to be drawn, such as in logistics, manufacturing and
                  robotics.
                </p>
