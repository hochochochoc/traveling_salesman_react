...
const TravelingProvider = ({ children }) => {
  ...
  const fixedValues = {
    ...
    Iraq: { zoom: 5.2, center: { lat: 33.2232, lng: 43.6793 } },
    ...
    Poland: { zoom: 5.3, center: { lat: 51.9194, lng: 19.1451 } },
    Paraguay: { zoom: 5.3, center: { lat: -23.4425, lng: -58.4438 } },
    Benin: { zoom: 5.85, center: { lat: 9.3077, lng: 2.3158 } },
    Belarus: { zoom: 5.35, center: { lat: 53.7098, lng: 27.9534 } },
    Venezuela: { zoom: 4.8, center: { lat: 6.4238, lng: -66.5897 } },
    Netherlands: { zoom: 6.4, center: { lat: 52.1326, lng: 5.2913 } },
    Nepal: { zoom: 5.4, center: { lat: 28.3949, lng: 84.124 } },
    ...
    Senegal: { zoom: 6, center: { lat: 14.4974, lng: -14.4524 } },
    ...
    Kenya: { zoom: 5.3, center: { lat: 0.0236, lng: 37.9062 } },
    Oman: { zoom: 5.2, center: { lat: 21.4735, lng: 55.9754 } },
    ...
    "South Sudan": { zoom: 5.0, center: { lat: 6.877, lng: 29.707 } },
    Sudan: { zoom: 4.5, center: { lat: 16.8628, lng: 30.2176 } },
    Romania: { zoom: 5.35, center: { lat: 45.9432, lng: 24.9668 } },
    Zimbabwe: { zoom: 5.5, center: { lat: -19.0154, lng: 29.1549 } },
    Syria: { zoom: 5.8, center: { lat: 34.8021, lng: 38.9968 } },
    Yemen: { zoom: 5, center: { lat: 15.5527, lng: 48.5164 } },
    Mauritania: { zoom: 4.9, center: { lat: 21.0079, lng: -10.9408 } },
    "Ivory Coast": { zoom: 5.75, center: { lat: 7.54, lng: -5.5471 } },
    Namibia: { zoom: 4.75, center: { lat: -22.9576, lng: 18.4904 } },
  };
